...
namespace ASF.Services.Http
{
    ...
    public class OrderDetailService : ApiController
    {
        ...
        [HttpGet]
        [Route("All")]
        public AllResponse<OrderDetail> All()
        {
            try
            {
                var response = new AllResponse<OrderDetail>();
                var bc = new OrderDetailBusiness();
        ...
        [HttpGet]
        [Route("Find/{id}")]
        public FindResponse<OrderDetail> Find(int id)
        {
            try
            {
                var response = new FindResponse<OrderDetail>();
                var bc = new OrderDetailBusiness();
